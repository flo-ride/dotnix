...
in {
  wayland.windowManager.hyprland.settings = {
    ...
    windowrulev2 = [
      ...
      "monitor DP-1, class:^(Desktop Heroes)$"
      "noblur, class:^(Desktop Heroes)$"
      "noborder, class:^(Desktop Heroes)$"
      "noshadow, class:^(Desktop Heroes)$"
      "opacity 1.0 override 1.0 override, class:^(Desktop Heroes)$"
    ];
  };
